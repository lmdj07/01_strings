...
class TestString < MiniTest::Unit::TestCase
  ...
  def test_convert_a_string_representation_of_a_number_to_a_real_number
    ...
    str_1 = "50"
    actual = str_1.to_i  # use the method in the docs above to convert the string to a number
  ...
  def test_convert_a_string_representation_of_a_number_to_a_real_number
    ...
    str_1 = "  word   "
    actual = str_1.strip  # use the method in the docs above to strip off the extra spaces
